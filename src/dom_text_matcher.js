...
(function() {
  ...
  window.DomTextMatcher = (function() {
    ...
    DomTextMatcher.prototype.searchFuzzyWithContext = function(prefix, suffix, pattern, expectedStart, expectedEnd, caseSensitive, path, options) {
      var analysis, charRange, expectedPrefixStart, expectedSuffixStart, len, mappings, match, matchThreshold, patternLength, prefixEnd, prefixResult, remainingText, suffixResult, suffixStart, _ref, _ref1, _ref2;
